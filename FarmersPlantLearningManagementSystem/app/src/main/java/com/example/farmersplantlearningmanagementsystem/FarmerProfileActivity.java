...
public class FarmerProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editHouseNo = findViewById(R.id.editHouseNo);
        EditText editStreet1 = findViewById(R.id.editStreet1);
        EditText editStreet2 = findViewById(R.id.editStreet2);
        EditText editBarangay = findViewById(R.id.editBarangay);
        EditText editCity = findViewById(R.id.editCity);
        EditText editZip = findViewById(R.id.editZip);
        Spinner spnMon = findViewById(R.id.spnMon);
        Spinner spnDay = findViewById(R.id.spnDay);
        Spinner spnYear = findViewById(R.id.spnYear);
        ...
        ImageButton profileBtn2 = findViewById(R.id.profileButton2);
        profileBtn2.setOnClickListener(view -> {
            Intent FarmerProfileActivityIntent = new Intent(FarmerProfileActivity.this, FarmerProfileActivity.class);
            startActivity(FarmerProfileActivityIntent);
        });

        ImageButton moduleBtn2 = findViewById(R.id.moduleButton2);
        moduleBtn2.setOnClickListener(view -> {
            Intent FarmerModuleActivityIntent = new Intent(FarmerProfileActivity.this, FarmerModuleActivity.class);
            startActivity(FarmerModuleActivityIntent);
        });

        ImageButton taskBtn2 = findViewById(R.id.taskButton2);
        taskBtn2.setOnClickListener(view -> {
            Intent FarmerTaskActivityIntent = new Intent(FarmerProfileActivity.this, FarmerTaskActivity.class);
            startActivity(FarmerTaskActivityIntent);
        });

        ImageButton gradeBtn2 = findViewById(R.id.gradeButton2);
        gradeBtn2.setOnClickListener(view -> {
            Intent FarmerGradeActivityIntent = new Intent(FarmerProfileActivity.this, FarmerGradeActivity.class);
